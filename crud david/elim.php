...
<head>
    ...
    <link rel="stylesheet" href="elim.css">
</head>
<body>

            <h1>
              Estas seguro de Eliminar a este usuario?
              <br>Si es asi presiona el boton eliminar, si no vuelve a la pagina principal<br>
            </h1>
...
<form name="eliminar" action="eli.php" method="POST">
...
$id = $_GET["id"];
  ...
  <tr>
    ...
    <td>
    <button name="elimina">Eliminar</button>
