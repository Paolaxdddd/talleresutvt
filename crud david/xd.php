        ...
        while ($row = mysqli_fetch_array($query))
{
          ...
          <td>" .$row['estatus']."</td>
          <td>
            <button name='delete'><a href='elim.php?id=".$row['id']."'>Eliminar</a></button>
            <button name='modificar'><a href='actualizar.php?id=".$row['id']".'>Modificar</a></button>
          </td>
          </tr>
          </table>";
    ...
    ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <button name="modificar"><a
                                    href="actualizar.php?id=<?php echo $row['id']; ?>">Modificar</a></button>
